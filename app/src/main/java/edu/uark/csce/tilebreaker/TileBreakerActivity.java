...
public class TileBreakerActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tile_breaker);
        ...
        findViewById(R.id.pause).setOnTouchListener(mDelayHideTouchListener);
        findViewById(R.id.upgrade).setOnTouchListener(mDelayHideTouchListener);
    }
